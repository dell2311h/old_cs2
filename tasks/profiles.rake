namespace :profiles do
  task :create_default => :environment do
    ...
    audio_normalize_command = master_track.commands.create :job_name => "audio_normalize", :ordering_number => 1, :input_from_command_with_number => 0
    audio_join_command = master_track.commands.create :job_name => "audio_join", :ordering_number => 2, :input_from_command_with_number => 1
    ...
    streaming_command5.options.create :key => "bitrate", :value => 300
    ...
    streaming_command6.options.create :key => "bitrate", :value => 600
    ...
    streaming_command7.options.create :key => "bitrate", :value => 900
    ...
    streaming_command8.options.create :key => "bitrate", :value => 300
    ...
    streaming_command9.options.create :key => "bitrate", :value => 600
    ...
    streaming_command10.options.create :key => "bitrate", :value => 900
    ...
    streaming_command11.options.create :key => "bitrate", :value => 300
    ...
    streaming_command12.options.create :key => "bitrate", :value => 600
    ...
    streaming_command13.options.create :key => "bitrate", :value => 900
